...
require_once BRASA_REQUEST_A_QUOTE_DIR . 'inc/settings-class.php';
// include settings api options
require_once BRASA_REQUEST_A_QUOTE_DIR . 'inc/settings-options.php';
